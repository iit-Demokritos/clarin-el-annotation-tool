...
APPLICATION_NAME = "Ellogon Web Annotation Tool"
...
if DJANGO_VERSION[0] >= 6:
    ADMINS = [
        '"Django Admin" <ellogon@iit.demokritos.gr>',
        '"Georgios Petasis" <petasisg@gmail.com>',
    ]
else:
    ADMINS = [
        ("Django Admin", "ellogon@iit.demokritos.gr"),
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            os.path.join(
                BASE_DIR, "templates"
            ),  # os.path.join(BASE_DIR, 'clarinangular/clarin-angular/src')
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": f"API for the back-end of the {APPLICATION_NAME}",
    "VERSION": "1.0.0",
    # OTHER SETTINGS
...
EMAIL_APP_NAME = APPLICATION_NAME  # name changed
EMAIL_USER_ACTIVATION_SUBJECT = (
    '{EMAIL_APP_NAME}: Account Activation for User: "{user}"'
)
EMAIL_USER_ACTIVATION_BODY = (
    "This is an automatic email from {sender}. Please do not reply to this e-mail!"
)
EMAIL_USER_RESET_SUBJECT = '{EMAIL_APP_NAME}: Account Password Reset for User: "{user}"'
EMAIL_USER_RESET_BODY = (
    "This is an automatic email from {sender}. Please do not reply to this e-mail!"
)

# share project variables
EMAIL_USER_SHARE_COLLECTION_SUBJECT = (
    "{EMAIL_APP_NAME} wants to share a collection with you!"
)
EMAIL_USER_SHARE_COLLECTION_BODY = (
    "This is an automatic email from {sender}. Please do not reply to this e-mail!"
)
...
APP_LOGO = "/static/assets/images/logo.svg"
PASSWORD_HASHERS = [
