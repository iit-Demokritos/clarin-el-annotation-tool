		...
		switch (annotatorType) {
			case "Button Annotator":
				...
				.then(function(response) {
					...
					return ButtonAnnotator.getAnnotationAttributes(responseData.savedAnnotationSchema.language, responseData.savedAnnotationSchema.annotation_type);
				})
				.then(function(response) {
					responseData.annotationSchemaOptions.attributes = response.attributes;
					return ButtonAnnotator.getAttributeAlternatives(responseData.savedAnnotationSchema.language, responseData.savedAnnotationSchema.annotation_type, responseData.savedAnnotationSchema.attribute);
				})
				.then(function(response) {
					responseData.annotationSchemaOptions.alternatives = response.alternatives;
					return ButtonAnnotator.getValues(responseData.savedAnnotationSchema.language, responseData.savedAnnotationSchema.annotation_type, responseData.savedAnnotationSchema.attribute, responseData.savedAnnotationSchema.alternative);
				})
				.then(function(response) {
			...
			case "Coreference Annotator":
				...
				.then(function(response) {
					responseData.annotationSchemaOptions.annotation_types = response.annotation_types;
					return CoreferenceAnnotator.getAttributeAlternatives(responseData.savedAnnotationSchema.language, responseData.savedAnnotationSchema.annotation_type);
				})
				.then(function(response) {
					responseData.annotationSchemaOptions.alternatives = response.alternatives;
					return CoreferenceAnnotator.getValues(responseData.savedAnnotationSchema.language, responseData.savedAnnotationSchema.annotation_type, responseData.savedAnnotationSchema.alternative);
				})
				.then(function(response) {
