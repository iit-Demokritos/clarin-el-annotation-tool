angular.module('clarin-el').directive('annotationButton', function (TextWidgetAPI, TempAnnotation, ButtonColor, Dialog) {
  return {
    ...
    link: function (scope, element, attrs) {
      ButtonColor.addColorCombination({
        value: attrs.annotationValue, bg_color: attrs.bgColor, fg_color: attrs.fgColor,
      ...
      var updateSelectedAnnotationButton = function () {
        ...
        if (!angular.equals({}, selectedAnnotation)) { //if selected annotation is not empty 
          var selectedAnnotationAttribute = _.where(selectedAnnotation.attributes, {
            name: attrs.annotationAttribute,
            value: attrs.annotationValue
          })[0];
